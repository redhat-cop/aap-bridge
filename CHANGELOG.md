...
Change bullets under version sections must end with a period (enforced by
pre-commit / CI via `tools/check_changelog_periods.py` on this file and
...
- **Changelog – Trailing Periods**: Keep a Changelog-style bullets in `CHANGELOG.md`
